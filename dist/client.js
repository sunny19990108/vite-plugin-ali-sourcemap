...
class Client {
    ...
    createClient(clientConfig) {
        ...
        // 访问的域名
        config.endpoint = `arms.${clientConfig.regionId || "cn-beijing"}.aliyuncs.com`;
        this.client = new arms20190808_1.default(config);
    }
    main(uploadFile) {
        let uploadRequest = new $ARMS20190808.UploadRequest(Object.assign(Object.assign({ regionId: "cn-beijing" }, this.uploadDefaultConfig), uploadFile));
